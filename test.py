...
from tensorflow import SimpleRNN, Dense, Dropout, Embedding, Bidirectional
from tensorflow import Tokenizer
from tensorflow import pad_sequences
from tensorflow import to_categorical
from sklearn.preprocessing import LabelEncoder
from tensorflow import EarlyStopping, ReduceLROnPlateau
...
# Convert one-hot encoded y back to categorical 
...
# Enhanced RNN Model with GloVe embeddings
def build_rnn_model():
    model = Sequential()
    
    # Add embedding layer with GloVe weights (partially trainable)
    ...
    # Add bidirectional RNN layer for better context understanding
